...
Builds an in-memory Spec using the speclib-python (afspec) construction
API, validates it, and writes it to disk.
"""
...
def main() -> None:
    ...
    # Write to disk
    out_dir = Path(__file__).resolve().parent / "01_audit_hub_output"
